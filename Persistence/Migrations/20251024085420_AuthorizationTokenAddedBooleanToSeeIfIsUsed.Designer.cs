...
namespace Persistence.Migrations
{
    ...
    [Migration("20251024085420_AuthorizationTokenAddedBooleanToSeeIfIsUsed")]
    partial class AuthorizationTokenAddedBooleanToSeeIfIsUsed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistence.Models.AuthorizationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Models.ConstructionSite", b =>
                {
                    b.HasOne("Persistence.Models.Client", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Persistence.Models.MaterialMovement", b =>
                {
                    ...
                    b.HasOne("Persistence.Models.Material", "Material")
                        .WithMany()
