function UpdateWorkerList() {
    ...
    //  AJAX
    AjaxCallToUpdateWorkerList(1, pageSizeValue, searchValue, sortByValue, orderByValue);
}

function UpdateWorkerListViaSortBy(sortBy) {
    // obter cenas da pagina
    ...
    switch (sortBy) {
        case 'Name':
            ...
            document.getElementById('tableHeader-PricePerHour').className = "btn btn-outline-dark btn-sm w-100 w-md-auto";
            break;
        case "PricePerHour":
            document.getElementById('tableHeader-' + sortBy).className = "btn btn-dark btn-sm w-100 w-md-auto";
...
function AjaxCallToUpdateWorkerList(page,pageSizeValue,searchValue,sortByValue,orderByValue) {
...
function ChangePage(next, pageCount)
{
    ...
    AjaxCallToUpdateWorkerList(currentPage, pageSizeValue, searchValue, sortByValue, orderByValue);
